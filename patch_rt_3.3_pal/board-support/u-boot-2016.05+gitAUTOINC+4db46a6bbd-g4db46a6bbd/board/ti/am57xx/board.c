...
#ifdef CONFIG_JN_PAL5728
    #define BOARD_NAME "JN-pal5728"
    #define PADCONF_ARRAY core_padconf_array_JN_pal5728
    #include "JN-pal5728_mux_data.h"
#else
    #define BOARD_NAME "beagle_x15"
    #define PADCONF_ARRAY core_padconf_array_essential_x15
    #include "mux_data.h"
#endif
...
void recalibrate_iodelay(void)
{
	...
	if (board_is_am572x_idk()) {
		...
		pconf = PADCONF_ARRAY;
		pconf_sz = ARRAY_SIZE(PADCONF_ARRAY);
