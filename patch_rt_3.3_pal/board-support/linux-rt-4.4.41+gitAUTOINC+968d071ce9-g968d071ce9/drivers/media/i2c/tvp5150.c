...
static v4l2_std_id tvp5150_read_std(struct v4l2_subdev *sd)
{
	int val = 0;
	tvp5150_write(sd, TVP5150_VIDEO_STD, 0x00);
	val = tvp5150_read(sd, TVP5150_STATUS_REG_5);
	printk("AAtvp5150 std %02x\n", val);
...
static int tvp5150_s_stream(struct v4l2_subdev *sd, int enable)
{
	...
	val &= ~(TVP5150_MISC_CTL_YCBCR_OE | TVP5150_MISC_CTL_SYNC_OE | TVP5150_MISC_CTL_CLOCK_OE);
			 ...
			 const struct i2c_device_id *id)
{
	...
	strlcpy(sd->name, "tvp5150", sizeof(sd->name));
